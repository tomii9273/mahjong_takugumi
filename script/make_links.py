...
# 抜け番あり6+1戦
# https://github.com/tomii9273/mahjong_takugumi/pull/40

for n_taku in range(7, 31):
    print(f'<a href="nukeari_6and1_sen/{n_taku}taku_{n_taku * 4 + 2}nin_6and1sen.txt">{n_taku}卓{n_taku * 4 + 2}人</a><br />')
